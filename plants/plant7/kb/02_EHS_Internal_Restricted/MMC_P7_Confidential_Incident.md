# MMC Plant 7 — Confidential Incident Brief

**Sensitivity:** RESTRICTED — Internal EHS Leadership + Plant Manager only.
**Document ID:** P7-INC-CONF-2026-001
**Author:** Plant 7 EHS Director
...
unauthorised retrieval — revoke this source from `plant7-ehs`'s mapping in
