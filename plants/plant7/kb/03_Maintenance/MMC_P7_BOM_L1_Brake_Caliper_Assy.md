# MMC Plant 7 — BOM: Line 1 Brake Caliper Assembly

**Document owner:** Plant 7 Maintenance & Engineering
...
- Build schedule: `MMC_P7_L1_Build_Schedule.md`
- QA spec: `MMC_P7_Brake_Caliper_QA_Spec.md`
