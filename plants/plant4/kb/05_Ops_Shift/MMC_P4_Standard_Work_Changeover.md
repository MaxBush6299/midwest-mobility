# MMC Plant 4 — Standard Work: Changeover Procedures
**Document ID:** MMC_P4_Standard_Work_Changeover  
**Document Owner:** Production Manager, Plant 4  
**Version:** v1.0  
**Effective Date:** 2026-01-26  
**Review Cycle:** Annual  
**Applies To:** All personnel performing changeovers on Lines 1, 2, and 3 at MMC Plant 4

---

## 1. Purpose

This document establishes standardized changeover procedures for production lines at MMC Plant 4. Standardized changeovers ensure safety, quality, and efficiency by defining the sequence of tasks, responsibilities, and verification steps required when transitioning between products or production configurations.
...
- **MMC_P4_LOTO_SOP** — Lockout/Tagout for all energy isolation
- **MMC_P4_Machine_Guarding_SOP** — Guard removal and reinstallation
- **MMC_P4_PPE_Matrix** — Required PPE for each work area
...
| MMC_P4_Quality_Policy | Quality Policy and Management System |
